            ...
            do
            {
                ...
                switch (choice)
                {
                    ...
                    case 8:
                        ...
                        var foundCourses1 = course.FindAll(co => co.courseName.Contains(searchTerm1) || co.courseCode.Contains(searchTerm1));
                        if (foundCourses1.Count > 0)
                        {
                            Console.WriteLine("Matching Courses:");
                            foreach (var c1 in foundCourses1)
                            {
